...
\\
Im Use-Case sind die Möglichkeiten, Verwalte Repository, Verwalte Rechte, \gls{Clone} Repository, Bearbeite Quellecode, Erstelle Branch, merge Branch und \gls{Switch} Branch aufgeführt. \\
\\
...
\begin{tabularx}{\textwidth}{lX}
\textbf{Erweiterungen:}\\\\
\qquad \qquad (1.-4.)b. & Der Nutzer bricht den Vorgang ab.\\
\qquad \qquad (1.-4.)b.1. & Das Use-Case endet erfolglos.\\
\\
...
\begin{tabularx}{\textwidth}{lX}
\textbf{Erweiterungen:}\\\\
\qquad \qquad (1.-13.)b. & Der Nutzer bricht den Vorgang ab.\\
\qquad \qquad (1.-13.)b.1. & Das Use-Case endet erfolglos.\\
\\
\qquad \qquad 2.a. & Die Verbindung zum Server kann nicht hergestellt werden. \\
\qquad \qquad 2.a.1. & Das System informiert den Nutzer. \\
\qquad \qquad 2.a.2. & Das Use Case endet erfolglos. \\
...
\\
\qquad \qquad 12.a. & Das System stellt Überschneidungen fest.\\
\qquad \qquad 12.a.1. & Der Nutzer wird aufgefordert die zu übernehmenden Änderungen auszuwählen.\\
\qquad \qquad 12.a.2. & Fortsetzung bei 13.\\
\end{tabularx}
...
\qquad \qquad 1.a.3. & Fortsetzung bei 2.\\\\
\qquad \qquad (1.-2.)b. & Der Nutzer bricht den Vorgang ab.\\
\qquad \qquad (1.-2.)b.1. & Das Use-Case endet erfolglos.\\\\\hline\hline\\
\end{tabularx}
...
\qquad \qquad (1.-2.)b. & Der Nutzer bricht den Vorgang ab.\\
\qquad \qquad (1.-2.)b.1. & Das Use-Case endet erfolglos.\\\\
...
\begin{tabularx}{\textwidth}{lX}
\textbf{Erweiterungen:}\\\\
\qquad \qquad 2.a. & Das System kann keine Verbindung zum Git-Server herstellen.\\
\qquad \qquad 2.a.1. & Das Use-Case endet erfolglos\\\\
\qquad \qquad (1.-2.)b. & Der Nutzer bricht den Vorgang ab.\\
\qquad \qquad (1.-2.)b.1. & Das Use-Case endet erfolglos.\\\\
\end{tabularx}
\newpage
...
\begin{tabularx}{\textwidth}{lX}
\textbf{Erweiterungen:}\\\\
\qquad \qquad 1.a. & Das System kann keine Verbindung zum Git-Server herstellen.\\
\qquad \qquad 1.a.1 & Das Use-Case endet erfolglos.\\\\
...
Das Repository ist die Hauptklasse unseres Modells. Es kann ein Repository auf einem Server existieren, von dem beliebig viele lokale Repositories geklont werden können (siehe Clone Repository - Zustandsdiagramm). Zu jedem Repository gehören mindestens ein oder mehrere Branches und beliebig viele \gls{Changeset}s. Jeder Branch enthält einen \gls{Pointer} (\gls{Head}) welcher auf das letzte in diesem Branch erzeugte Changeset zeigt. Die Changesets zeigen mittels eines Pointers auf das jeweilige Changeset welches zuvor erzeugt wurde. Durch diese listenartige Verkettung entsteht die History. Durch die Verschiebung des Heads besteht die Möglichkeit vorgenommene Änderungen wieder rückgängig zu machen. Jedes Changeset beinhaltet mindestens eine Modifikation. Eine Modifikation ist eine zusammenhängende Textpassage (durch die Offsets definiert) in einer Datei die geändert wurde. 
...
Git hat uns beste Möglichkeiten geboten gemeinsam an dem Projekt zu arbeiten.
Die Versionsverwalung und das Austauschen der Daten ermöglichten uns auch in Zweiergruppen an den Teilen zu arbeiten. \\
Das gemeinschaftliche Zusammenfügen der Daten lief dann problemlos.\\
Allerdings ist auch nicht zu vernachlässigen, dass wir das Git-System bis an die Grenzen betrieben haben und es zu dem ein oder anderen Konflikt mit er Software kam.\\
Alles in allem lässt sich die Teamarbeit als erfolgreich betrachten. Auch wenn es nicht imer einfach war ein gemeinsames Treffen zu koordinieren. 
\\\\


\section{\underline{Schlussbetrachtung}}
	
Zusammenfassend lässt sich sagen, dass diese Projektarbeit eine gute Möglichkeit war sich mit Git und mit den Werkzeugen des Software Engineerings auseinander zu setzen.\\
Es ist allerdings zu bedenken, dass man eine gewisse Einbearbeitungszeit benötigt um mit Git umgehen zu können.\\
Des Weiteren haben wir dieses Projekt dazu genutzt uns mit Latex zu beschäftigen. Es hat uns fasziniert die Möglichkeiten von Latex zu entdecken, auch wenn es einige Probleme ergab. \\
