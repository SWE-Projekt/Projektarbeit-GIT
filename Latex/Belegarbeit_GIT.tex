...
\newglossaryentry{push}		{name=Push		,description={engl. anschieben - Mit diesem Befehl werden die lokalen Änderungen auf den Server übertragen}}
%-------------------------------------------------------------------------------------
...
\qquad 2. & Das System listet die Rechte der ausgewählten Gruppe. \\
\qquad 3. & Der Admin gibt entsprechende Kommandos zum Verwalten der Rechte ein. \\
\qquad 4. & Das System informiert den Admin über eine erfolgreiche Ausführung der Aktion.\\
\qquad 5. & Das Use Case endet erfolgreich.\\\\\hline
\end{tabularx}
...
Die Versionsverwaltung und das Austauschen der Daten ermöglichten uns auch in Zweiergruppen an den einzelnen Teilen zu arbeiten. Das gemeinschaftliche Zusammenfügen der Daten lief dann problemlos. Allerdings ist auch nicht zu vernachlässigen, dass wir das Git-System bis an die Grenzen betrieben haben und es zu dem ein oder anderen Konflikt mit der Software kam. Alles in allem lässt sich die Teamarbeit als erfolgreich betrachten. Auch wenn es nicht immer einfach war ein gemeinsames Treffen zu koordinieren. 
\\\\
