...
Desweiteren bietet Git ein Webinterface.
...
\newpage	
\underline{\textbf{\textsc{Anmeldung (=Clone Repository)}}}\\
\includegraphics[width=\textwidth]{Clone.jpg}\\\\
Zu Beginn eines Projektes muss der Anwender ein Repository zu seinem Projekt hinzufügen.
